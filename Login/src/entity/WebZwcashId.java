...
/**
 * WebZwcashId entity. @author MyEclipse Persistence Tools
 */

public class WebZwcashId implements java.io.Serializable {
	...
	/** full constructor */
	public WebZwcashId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebZwcashId))
			return false;
		WebZwcashId castOther = (WebZwcashId) other;
