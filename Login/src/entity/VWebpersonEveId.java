...
/**
 * VWebpersonEveId entity. @author MyEclipse Persistence Tools
 */

public class VWebpersonEveId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebpersonEveId() {
	}

	/** minimal constructor */
	public VWebpersonEveId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebpersonEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebpersonEveId))
			return false;
		VWebpersonEveId castOther = (VWebpersonEveId) other;
