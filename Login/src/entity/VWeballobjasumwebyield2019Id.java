...
/**
 * VWeballobjasumwebyield2019Id entity. @author MyEclipse Persistence Tools
 */

public class VWeballobjasumwebyield2019Id implements java.io.Serializable {
	...
	/** default constructor */
	public VWeballobjasumwebyield2019Id() {
	}

	/** full constructor */
	public VWeballobjasumwebyield2019Id(String factNo, String factCode,
			String yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWeballobjasumwebyield2019Id))
			return false;
		VWeballobjasumwebyield2019Id castOther = (VWeballobjasumwebyield2019Id) other;
