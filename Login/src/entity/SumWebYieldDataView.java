...
public class SumWebYieldDataView implements java.io.Serializable {
	...
	/** default constructor */
	public SumWebYieldDataView() {
	}

	/** minimal constructor */
	public SumWebYieldDataView(SumWebYieldDataId id) {
		this.id = id;
	}

	/** full constructor */
	public SumWebYieldDataView(SumWebYieldDataId id, BigDecimal sumWorkdays,
			...
			String endDate,Double sumWorkhours) {
		this.id = id;
