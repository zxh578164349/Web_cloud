...
/**
 * VWeboutputinvId entity. @author MyEclipse Persistence Tools
 */

public class VWeboutputinvId implements java.io.Serializable {
	...
	/** default constructor */
	public VWeboutputinvId() {
	}

	/** minimal constructor */
	public VWeboutputinvId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWeboutputinvId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWeboutputinvId))
			return false;
		VWeboutputinvId castOther = (VWeboutputinvId) other;
