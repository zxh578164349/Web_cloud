...
/**
 * VWebgwId entity. @author MyEclipse Persistence Tools
 */

public class VWebgwId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VWebgwId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebgwId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebgwId))
			return false;
		VWebgwId castOther = (VWebgwId) other;
