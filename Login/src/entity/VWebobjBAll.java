...
public class VWebobjBAll implements java.io.Serializable {
	...
	private Double sumObjA7;//當月總招工數
	private Double sumObjA8;//當月總離職數
	private Double CObjA6;//直工人數
	private Double CObjA7;//間工人數
	private Double CObjA8;//全廠人數
	...
	public VWebobjBAll(VWebobjBAllId id, Double totalhole, Double machinepower,
			...
			Double CObjA7, Double CObjA8, Double CObjA2, Double CObjA10,
