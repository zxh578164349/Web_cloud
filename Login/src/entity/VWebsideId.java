...
/**
 * VWebsideId entity. @author MyEclipse Persistence Tools
 */

public class VWebsideId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VWebsideId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebsideId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebsideId))
			return false;
		VWebsideId castOther = (VWebsideId) other;
