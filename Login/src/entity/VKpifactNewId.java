...
/**
 * VKpifactNewId entity. @author MyEclipse Persistence Tools
 */

public class VKpifactNewId implements java.io.Serializable {
	...
	/** default constructor */
	public VKpifactNewId() {
	}

	/** full constructor */
	public VKpifactNewId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VKpifactNewId))
			return false;
		VKpifactNewId castOther = (VKpifactNewId) other;
