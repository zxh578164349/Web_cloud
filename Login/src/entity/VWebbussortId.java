...
/**
 * VWebbussortId entity. @author MyEclipse Persistence Tools
 */

public class VWebbussortId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebbussortId() {
	}

	/** full constructor */
	public VWebbussortId(String factNo, String yymm) {
		this.factNo = factNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebbussortId))
			return false;
		VWebbussortId castOther = (VWebbussortId) other;
