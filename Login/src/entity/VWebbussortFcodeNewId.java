...
/**
 * VWebbussortFcodeNewId entity. @author MyEclipse Persistence Tools
 */

public class VWebbussortFcodeNewId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebbussortFcodeNewId() {
	}

	/** full constructor */
	public VWebbussortFcodeNewId(WebFact fact, String yymm) {
		this.fact = fact;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebbussortFcodeNewId))
			return false;
		VWebbussortFcodeNewId castOther = (VWebbussortFcodeNewId) other;
