...
/**
 * WebCpstoreId entity. @author MyEclipse Persistence Tools
 */

public class WebCpstoreId implements java.io.Serializable {
	...
	/** full constructor */
	public WebCpstoreId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebCpstoreId))
			return false;
		WebCpstoreId castOther = (WebCpstoreId) other;
