...
/**
 * VWeballobjasumwebyieldId entity. @author MyEclipse Persistence Tools
 */

public class VWeballobjasumwebyieldId implements java.io.Serializable {
	...
	/** default constructor */
	public VWeballobjasumwebyieldId() {
	}

	/** full constructor */
	public VWeballobjasumwebyieldId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWeballobjasumwebyieldId))
			return false;
		VWeballobjasumwebyieldId castOther = (VWeballobjasumwebyieldId) other;
