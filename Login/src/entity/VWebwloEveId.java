...
/**
 * VWebwloEveId entity. @author MyEclipse Persistence Tools
 */

public class VWebwloEveId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VWebwloEveId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebwloEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebwloEveId))
			return false;
		VWebwloEveId castOther = (VWebwloEveId) other;
