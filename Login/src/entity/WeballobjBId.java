...
/**
 * WeballobjBId entity. @author MyEclipse Persistence Tools
 */

public class WeballobjBId implements java.io.Serializable {
	...
	/** full constructor */
	public WeballobjBId(WebFact fact, String yymm) {
		this.fact = fact;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WeballobjBId))
			return false;
		WeballobjBId castOther = (WeballobjBId) other;
