...
/**
 * WebwloId entity. @author MyEclipse Persistence Tools
 */

public class WebwloId implements java.io.Serializable {
	...
	/** full constructor */
	public WebwloId(String factNo, String factCode, Date yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebwloId))
			return false;
		WebwloId castOther = (WebwloId) other;
