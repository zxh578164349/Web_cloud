...
/**
 * VWebydataawebcashoutId entity. @author MyEclipse Persistence Tools
 */

public class VWebydataawebcashoutId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebydataawebcashoutId() {
	}

	/** minimal constructor */
	public VWebydataawebcashoutId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebydataawebcashoutId(String factNo, String factCode, Date yymmdd) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymmdd = yymmdd;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebydataawebcashoutId))
			return false;
		VWebydataawebcashoutId castOther = (VWebydataawebcashoutId) other;
