...
/**
 * VSumwloId entity. @author MyEclipse Persistence Tools
 */

public class VSumwloId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VSumwloId(String factNo) {
		this.factNo = factNo;
	}

	/** full constructor */
	public VSumwloId(String factNo, String yymm) {
		this.factNo = factNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VSumwloId))
			return false;
		VSumwloId castOther = (VSumwloId) other;
