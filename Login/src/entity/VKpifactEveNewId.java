...
/**
 * VKpifactEveNewId entity. @author MyEclipse Persistence Tools
 */

public class VKpifactEveNewId implements java.io.Serializable {
	...
	/** default constructor */
	public VKpifactEveNewId() {
	}

	/** full constructor */
	public VKpifactEveNewId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VKpifactEveNewId))
			return false;
		VKpifactEveNewId castOther = (VKpifactEveNewId) other;
