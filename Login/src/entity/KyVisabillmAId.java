...
/**
 * KyVisabillmAId entity. @author MyEclipse Persistence Tools
 */

public class KyVisabillmAId implements java.io.Serializable {
	...
	/** default constructor */
	public KyVisabillmAId() {
	}

	/** full constructor */
	public KyVisabillmAId(String factNo, String visaSort, String billNo) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KyVisabillmAId))
			return false;
		KyVisabillmAId castOther = (KyVisabillmAId) other;
