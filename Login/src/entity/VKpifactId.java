...
/**
 * VKpifactId entity. @author MyEclipse Persistence Tools
 */

public class VKpifactId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VKpifactId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VKpifactId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VKpifactId))
			return false;
		VKpifactId castOther = (VKpifactId) other;
