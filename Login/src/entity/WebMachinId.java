...
/**
 * WebMachinId entity. @author MyEclipse Persistence Tools
 */

public class WebMachinId implements java.io.Serializable {
	...
	/** full constructor */
	public WebMachinId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebMachinId))
			return false;
		WebMachinId castOther = (WebMachinId) other;
