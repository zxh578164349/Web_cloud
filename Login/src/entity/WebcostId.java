...
/**
 * WebcostId entity. @author MyEclipse Persistence Tools
 */

public class WebcostId implements java.io.Serializable {
	...
	/** full constructor */
	public WebcostId(String factNo, String factCode, Date yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebcostId))
			return false;
		WebcostId castOther = (WebcostId) other;
