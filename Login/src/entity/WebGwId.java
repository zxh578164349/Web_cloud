...
/**
 * WebGwId entity. @author MyEclipse Persistence Tools
 */

public class WebGwId implements java.io.Serializable {
	...
	/** full constructor */
	public WebGwId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebGwId))
			return false;
		WebGwId castOther = (WebGwId) other;
