...
/**
 * VWebmachineEveId entity. @author MyEclipse Persistence Tools
 */

public class VWebmachineEveId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebmachineEveId() {
	}

	/** minimal constructor */
	public VWebmachineEveId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebmachineEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebmachineEveId))
			return false;
		VWebmachineEveId castOther = (VWebmachineEveId) other;
