...
/**
 * VSuminvId entity. @author MyEclipse Persistence Tools
 */

public class VSuminvId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VSuminvId(String factNo) {
		this.factNo = factNo;
	}

	/** full constructor */
	public VSuminvId(String factNo, String yymm) {
		this.factNo = factNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VSuminvId))
			return false;
		VSuminvId castOther = (VSuminvId) other;
