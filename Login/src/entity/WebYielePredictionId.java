...
/**
 * WebYielePredictionId entity. @author MyEclipse Persistence Tools
 */

public class WebYielePredictionId implements java.io.Serializable {
	...
	/** default constructor */
	public WebYielePredictionId() {
	}

	/** full constructor */
	public WebYielePredictionId(String factNo, String factCode, Date yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof WebYielePredictionId))
			return false;
		WebYielePredictionId castOther = (WebYielePredictionId) other;
