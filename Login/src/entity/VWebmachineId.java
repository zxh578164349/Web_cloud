...
/**
 * VWebmachineId entity. @author MyEclipse Persistence Tools
 */

public class VWebmachineId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebmachineId() {
	}

	/** minimal constructor */
	public VWebmachineId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebmachineId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebmachineId))
			return false;
		VWebmachineId castOther = (VWebmachineId) other;
