...
/**
 * WebOutputinvId entity. @author MyEclipse Persistence Tools
 */

public class WebOutputinvId implements java.io.Serializable {
	...
	/** default constructor */
	public WebOutputinvId() {
	}

	/** full constructor */
	public WebOutputinvId(String factNo, String billNo, Date yymm,
			String factCode) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebOutputinvId))
			return false;
		WebOutputinvId castOther = (WebOutputinvId) other;
