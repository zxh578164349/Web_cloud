...
/**
 * Weballobj entity. @author MyEclipse Persistence Tools
 */

public class Weballobj implements java.io.Serializable {
	...
	/** minimal constructor */
	public Weballobj(WeballobjId id) {
		this.id = id;
	}
	...
	public WeballobjId getId() {
		return this.id;
	}

	public void setId(WeballobjId id) {
		this.id = id;
	}
