...
/**
 * WebProfitcountId entity. @author MyEclipse Persistence Tools
 */

public class WebProfitcountId implements java.io.Serializable {
	...
	/** default constructor */
	public WebProfitcountId() {
	}

	/** full constructor */
	public WebProfitcountId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebProfitcountId))
			return false;
		WebProfitcountId castOther = (WebProfitcountId) other;
