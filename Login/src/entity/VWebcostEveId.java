...
/**
 * VWebcostEveId entity. @author MyEclipse Persistence Tools
 */

public class VWebcostEveId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebcostEveId() {
	}

	/** minimal constructor */
	public VWebcostEveId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebcostEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebcostEveId))
			return false;
		VWebcostEveId castOther = (VWebcostEveId) other;
