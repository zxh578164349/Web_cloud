...
/**
 * KyzPettyId entity. @author MyEclipse Persistence Tools
 */

public class KyzPettyId implements java.io.Serializable {
	...
	/** full constructor */
	public KyzPettyId(String factNo, String billNo) {
		this.factNo = factNo;
		this.billNo = billNo;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KyzPettyId))
			return false;
		KyzPettyId castOther = (KyzPettyId) other;
