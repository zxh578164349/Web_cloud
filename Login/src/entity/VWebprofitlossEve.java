...
/**
 * VWebprofitlossEve entity. @author MyEclipse Persistence Tools
 */

public class VWebprofitlossEve implements java.io.Serializable {

	// Fields

	private VWebprofitlossEveId id;
	private Double objA100=0.0;
	private Double objA101=0.0;
	private Double objA102=0.0;
	private Double objA103=0.0;
	private Double objA104=0.0;
	private Double objA105=0.0;
	private Double objA106=0.0;
	private Double objA107=0.0;
	private Double objA108=0.0;
	private Double objA109=0.0;
	private Double objA110=0.0;
	private Double objA111=0.0;
	private Double objA112=0.0;
	private Double objA113=0.0;
	private Double objA114=0.0;
	private Double objA115=0.0;
	private Double objA116=0.0;
	private Double objA117=0.0;
	private Double objA118=0.0;
	private Long objA119=0L;
	private Long objA120=0L;
	private Double objA121=0.0;
	private Double objA122=0.0;
	private Double objA123=0.0;
	private Double objA124=0.0;
	private Long objA125=0L;
	private Long objA126=0L;
	private Long objA127=0L;
	private Double objA128=0.0;
	private Double objA129=0.0;
	private Double objA130=0.0;
	private Double objA131=0.0;
	private Double objA132=0.0;
	private Double objA133=0.0;
	private Double objA134=0.0;
	private Double objA135=0.0;
	private Double objA136=0.0;
	private Double objA137=0.0;
	private Double objA138=0.0;
	private Double objA139=0.0;
	private Double objA140=0.0;
	private Double objA141=0.0;
	private Double objA142=0.0;
	private Double objA143=0.0;
	private Double objA144=0.0;
	private Double objA145=0.0;
	private Double objA146=0.0;
	private Double objA147=0.0;
	private Double objA148=0.0;
	private Double objA149=0.0;
	private Double objA150=0.0;
	private Double objA151=0.0;
	private Double objA152=0.0;
	private Double objA153=0.0;
	private Double objA154=0.0;
	private Double objA155=0.0;
	private Double objA156=0.0;
	private Double objA157=0.0;
	private Double objA158=0.0;
	private Double objA159=0.0;
	private Double objA160=0.0;
	private Double objA161=0.0;
	private Double objA162=0.0;
	private Double objA163=0.0;
	private Double objA164=0.0;
	private Double objA165=0.0;
	private Double objA166=0.0;
	private Double objA167=0.0;
	private Double objA168=0.0;
	private Double objA169=0.0;
	private Double objA170=0.0;
	private Double objA171=0.0;
	private Double objA172=0.0;
	private Double objA173=0.0;
	private Double objA174=0.0;
	private Double objA175=0.0;
	private Double objA176=0.0;
	private Double objA177=0.0;
	private Double objA178=0.0;
	private Double objA179=0.0;
	private Double objA180=0.0;
	private Double objA181=0.0;
	private Double objA182=0.0;
	private Double objA183=0.0;
	private Double objA184=0.0;
	private Double objA185=0.0;
	private Double objA186=0.0;
	private Double objA187=0.0;
	private Double objA188=0.0;
	private Double objA189=0.0;
	private Double objA190=0.0;
	private Double objA191=0.0;
	private Double objA192=0.0;
	private Double objA193=0.0;
	private Double objA194=0.0;
	private Double objA195=0.0;
	private Double objA196=0.0;
	private Double objA197=0.0;
	private Double objA198=0.0;
	private Double objA199=0.0;
	private Double objA200=0.0;
	private Double objA201=0.0;
	private Double objA202=0.0;
	private Double hole=0.0;
	private Double machinepower=0.0;
	private Double estdays=0.0;
	private Double esteverymodel=0.0;
	private Double esteverypeople=0.0;
	private Double estmodel=0.0;
	private Double estnum=0.0;
	private Double estpay=0.0;
	private Double estmoney=0.0;
	private Double totalhole=0.0;
	private Double sample=0.0;
	private Double accessories=0.0;
	private Double other=0.0;
	private BigDecimal sumWorkdays=new BigDecimal(0.0);
	private BigDecimal sumEverypeople=new BigDecimal(0.0);
	...
	private BigDecimal sumHostpairs=new BigDecimal(0.0);
	private BigDecimal sumFactpairs=new BigDecimal(0.0);
	private BigDecimal sumSamplepairs=new BigDecimal(0.0);
	private BigDecimal sumOutnum=new BigDecimal(0.0);
	private BigDecimal sumBacknum=new BigDecimal(0.0);
	private Double sumWorkhours=0.0;

	// Constructors

	/** default constructor */
	public VWebprofitlossEve() {
	}

	/** minimal constructor */
	public VWebprofitlossEve(VWebprofitlossEveId id) {
		this.id = id;
	}

	/** full constructor */
	public VWebprofitlossEve(VWebprofitlossEveId id, Double objA100,
			Double objA101, Double objA102, Double objA103, Double objA104,
			Double objA105, Double objA106, Double objA107, Double objA108,
			Double objA109, Double objA110, Double objA111, Double objA112,
			Double objA113, Double objA114, Double objA115, Double objA116,
			Double objA117, Double objA118, Long objA119, Long objA120,
			Double objA121, Double objA122, Double objA123, Double objA124,
			Long objA125, Long objA126, Long objA127, Double objA128,
			Double objA129, Double objA130, Double objA131, Double objA132,
			Double objA133, Double objA134, Double objA135, Double objA136,
			Double objA137, Double objA138, Double objA139, Double objA140,
			Double objA141, Double objA142, Double objA143, Double objA144,
			Double objA145, Double objA146, Double objA147, Double objA148,
			Double objA149, Double objA150, Double objA151, Double objA152,
			Double objA153, Double objA154, Double objA155, Double objA156,
			Double objA157, Double objA158, Double objA159, Double objA160,
			Double objA161, Double objA162, Double objA163, Double objA164,
			Double objA165, Double objA166, Double objA167, Double objA168,
			Double objA169, Double objA170, Double objA171, Double objA172,
			Double objA173, Double objA174, Double objA175, Double objA176,
			Double objA177, Double objA178, Double objA179, Double objA180,
			Double objA181, Double objA182, Double objA183, Double objA184,
			Double objA185, Double objA186, Double objA187, Double objA188,
			Double objA189, Double objA190, Double objA191, Double objA192,
			Double objA193, Double objA194, Double objA195, Double objA196,
			Double objA197, Double objA198, Double objA199, Double objA200,
			Double objA201, Double objA202, Double hole, Double machinepower,
			...
			BigDecimal sumWorkdays, BigDecimal sumEverypeople,
			BigDecimal sumEverydemo, BigDecimal sumStandarddemo,
			BigDecimal sumActualdemo, BigDecimal sumActualpairs,
			BigDecimal sumHostpairs, BigDecimal sumFactpairs,
			BigDecimal sumSamplepairs, BigDecimal sumOutnum,
			BigDecimal sumBacknum, Double sumWorkhours) {
		this.id = id;
	...
	public VWebprofitlossEveId getId() {
		return this.id;
	}

	public void setId(VWebprofitlossEveId id) {
		this.id = id;
	}
	...
	public Long getObjA119() {
		return this.objA119;
	}

	public void setObjA119(Long objA119) {
		this.objA119 = objA119;
	}

	public Long getObjA120() {
		return this.objA120;
	}

	public void setObjA120(Long objA120) {
		this.objA120 = objA120;
	}
	...
	public Long getObjA125() {
		return this.objA125;
	}

	public void setObjA125(Long objA125) {
		this.objA125 = objA125;
	}

	public Long getObjA126() {
		return this.objA126;
	}

	public void setObjA126(Long objA126) {
		this.objA126 = objA126;
	}

	public Long getObjA127() {
		return this.objA127;
	}

	public void setObjA127(Long objA127) {
		this.objA127 = objA127;
	}
