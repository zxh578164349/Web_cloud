...
/**
 * VSumlossId entity. @author MyEclipse Persistence Tools
 */

public class VSumlossId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VSumlossId(String factNo) {
		this.factNo = factNo;
	}

	/** full constructor */
	public VSumlossId(String factNo, String yymm) {
		this.factNo = factNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VSumlossId))
			return false;
		VSumlossId castOther = (VSumlossId) other;
