...
/**
 * WebBrEstimatingitemId entity. @author MyEclipse Persistence Tools
 */

public class WebBrEstimatingitemId implements java.io.Serializable{
	...
	/** default constructor */
	public WebBrEstimatingitemId(){
	}

	/** full constructor */
	public WebBrEstimatingitemId(String factNo,String factCode,String yymmdd){
		this.factNo=factNo;
	...
	public boolean equals(Object other){
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebBrEstimatingitemId))
			return false;
		WebBrEstimatingitemId castOther=(WebBrEstimatingitemId)other;
