...
/**
 * VSumWebmix1Id entity. @author MyEclipse Persistence Tools
 */

public class VSumWebmix1Id implements java.io.Serializable {
	...
	/** default constructor */
	public VSumWebmix1Id() {
	}

	/** minimal constructor */
	public VSumWebmix1Id(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VSumWebmix1Id(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VSumWebmix1Id))
			return false;
		VSumWebmix1Id castOther = (VSumWebmix1Id) other;
