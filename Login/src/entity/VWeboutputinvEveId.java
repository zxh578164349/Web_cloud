...
/**
 * VWeboutputinvEveId entity. @author MyEclipse Persistence Tools
 */

public class VWeboutputinvEveId implements java.io.Serializable {
	...
	/** default constructor */
	public VWeboutputinvEveId() {
	}

	/** minimal constructor */
	public VWeboutputinvEveId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWeboutputinvEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWeboutputinvEveId))
			return false;
		VWeboutputinvEveId castOther = (VWeboutputinvEveId) other;
