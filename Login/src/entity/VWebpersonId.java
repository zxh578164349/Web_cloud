...
/**
 * VWebpersonId entity. @author MyEclipse Persistence Tools
 */

public class VWebpersonId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VWebpersonId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebpersonId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebpersonId))
			return false;
		VWebpersonId castOther = (VWebpersonId) other;
