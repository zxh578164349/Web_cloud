...
/**
 * VWebstoreId entity. @author MyEclipse Persistence Tools
 */

public class VWebstoreId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VWebstoreId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebstoreId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebstoreId))
			return false;
		VWebstoreId castOther = (VWebstoreId) other;
