...
/**
 * VWebsideEveId entity. @author MyEclipse Persistence Tools
 */

public class VWebsideEveId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebsideEveId() {
	}

	/** minimal constructor */
	public VWebsideEveId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebsideEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebsideEveId))
			return false;
		VWebsideEveId castOther = (VWebsideEveId) other;
