...
/**
 * WebOutbackId entity. @author MyEclipse Persistence Tools
 */

public class WebOutbackId implements java.io.Serializable {
	...
	/** full constructor */
	public WebOutbackId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebOutbackId))
			return false;
		WebOutbackId castOther = (WebOutbackId) other;
