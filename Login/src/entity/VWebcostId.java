...
/**
 * VWebcostId entity. @author MyEclipse Persistence Tools
 */

public class VWebcostId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VWebcostId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebcostId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebcostId))
			return false;
		VWebcostId castOther = (VWebcostId) other;
