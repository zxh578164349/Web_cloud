...
/**
 * WebbackfeedId entity. @author MyEclipse Persistence Tools
 */

public class WebbackfeedId implements java.io.Serializable {
	...
	/** default constructor */
	public WebbackfeedId() {
	}

	/** full constructor */
	public WebbackfeedId(String factNo, String factCode, Date yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebbackfeedId))
			return false;
		WebbackfeedId castOther = (WebbackfeedId) other;
