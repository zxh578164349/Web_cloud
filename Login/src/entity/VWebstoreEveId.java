...
/**
 * VWebstoreEveId entity. @author MyEclipse Persistence Tools
 */

public class VWebstoreEveId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebstoreEveId() {
	}

	/** minimal constructor */
	public VWebstoreEveId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebstoreEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebstoreEveId))
			return false;
		VWebstoreEveId castOther = (VWebstoreEveId) other;
