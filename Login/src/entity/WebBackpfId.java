...
/**
 * WebBackpfId entity. @author MyEclipse Persistence Tools
 */

public class WebBackpfId implements java.io.Serializable {
	...
	/** full constructor */
	public WebBackpfId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebBackpfId))
			return false;
		WebBackpfId castOther = (WebBackpfId) other;
