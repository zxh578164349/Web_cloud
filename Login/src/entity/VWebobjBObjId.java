...
/**
 * VWebobjBObjId entity. @author MyEclipse Persistence Tools
 */

public class VWebobjBObjId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebobjBObjId() {
	}

	/** full constructor */
	public VWebobjBObjId(WebFact webFact, String yymmdd) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebobjBObjId))
			return false;
		VWebobjBObjId castOther = (VWebobjBObjId) other;
