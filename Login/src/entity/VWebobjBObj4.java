...
/**
 * VWebobjBObj4 entity. @author MyEclipse Persistence Tools
 */

public class VWebobjBObj4 implements java.io.Serializable {

	// Fields

	private VWebobjBObj4Id id;
	...
	/** minimal constructor */
	public VWebobjBObj4(VWebobjBObj4Id id) {
		this.id = id;
	}

	/** full constructor */
	public VWebobjBObj4(VWebobjBObj4Id id, Double totalhole,
			Double machinepower, Double hole, Double sample,
			Double accessories, Double other, Double estmodel,
			Double estnum, Double estpay, Double onmodulus,
			Double personnum, Double standardoutput,
			Double actualyield, Double objaA, Double objaB,
			Double objaC, Double obja1, Double objaD,
			Double obja2, Double obja3, Double obja4) {
		this.id = id;
	...
	public VWebobjBObj4Id getId() {
		return this.id;
	}

	public void setId(VWebobjBObj4Id id) {
		this.id = id;
	}
