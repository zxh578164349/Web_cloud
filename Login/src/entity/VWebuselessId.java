...
/**
 * VWebuselessId entity. @author MyEclipse Persistence Tools
 */

public class VWebuselessId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebuselessId() {
	}

	/** full constructor */
	public VWebuselessId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebuselessId))
			return false;
		VWebuselessId castOther = (VWebuselessId) other;
