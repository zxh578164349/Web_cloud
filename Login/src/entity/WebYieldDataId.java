...
/**
 * WebYieldDataId entity. @author MyEclipse Persistence Tools
 */

public class WebYieldDataId implements java.io.Serializable {
	...
	/** default constructor */
	public WebYieldDataId() {
	}

	/** full constructor */
	public WebYieldDataId(String factNo, String factCode, Date yymmdd) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebYieldDataId))
			return false;
		WebYieldDataId castOther = (WebYieldDataId) other;
