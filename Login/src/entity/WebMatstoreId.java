...
/**
 * WebMatstoreId entity. @author MyEclipse Persistence Tools
 */

public class WebMatstoreId implements java.io.Serializable {
	...
	/** default constructor */
	public WebMatstoreId() {
	}

	/** full constructor */
	public WebMatstoreId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebMatstoreId))
			return false;
		WebMatstoreId castOther = (WebMatstoreId) other;
