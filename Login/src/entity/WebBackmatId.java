...
/**
 * WebBackmatId entity. @author MyEclipse Persistence Tools
 */

public class WebBackmatId implements java.io.Serializable {
	...
	/** full constructor */
	public WebBackmatId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebBackmatId))
			return false;
		WebBackmatId castOther = (WebBackmatId) other;
