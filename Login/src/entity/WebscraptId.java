...
/**
 * WebscraptId entity. @author MyEclipse Persistence Tools
 */

public class WebscraptId implements java.io.Serializable {
	...
	/** full constructor */
	public WebscraptId(String factNo, String factCode, Date yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebscraptId))
			return false;
		WebscraptId castOther = (WebscraptId) other;
