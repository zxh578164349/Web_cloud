...
/**
 * VWebwloId entity. @author MyEclipse Persistence Tools
 */

public class VWebwloId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VWebwloId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebwloId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebwloId))
			return false;
		VWebwloId castOther = (VWebwloId) other;
