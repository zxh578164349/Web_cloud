...
/**
 * VWebobjBYdateId entity. @author MyEclipse Persistence Tools
 */

public class VWebobjBYdateId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebobjBYdateId() {
	}

	/** full constructor */
	public VWebobjBYdateId(WebFact webFact, String yymmdd) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebobjBYdateId))
			return false;
		VWebobjBYdateId castOther = (VWebobjBYdateId) other;
