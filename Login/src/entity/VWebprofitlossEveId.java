...
/**
 * VWebprofitlossEveId entity. @author MyEclipse Persistence Tools
 */

public class VWebprofitlossEveId implements java.io.Serializable {
	...
	/** default constructor */
	public VWebprofitlossEveId() {
	}

	/** full constructor */
	public VWebprofitlossEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebprofitlossEveId))
			return false;
		VWebprofitlossEveId castOther = (VWebprofitlossEveId) other;
