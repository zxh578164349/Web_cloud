...
/**
 * VWebgwEveId entity. @author MyEclipse Persistence Tools
 */

public class VWebgwEveId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VWebgwEveId(String factNo, String factCode) {
		this.factNo = factNo;
		this.factCode = factCode;
	}

	/** full constructor */
	public VWebgwEveId(String factNo, String factCode, String yymm) {
		this.factNo = factNo;
		this.factCode = factCode;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VWebgwEveId))
			return false;
		VWebgwEveId castOther = (VWebgwEveId) other;
