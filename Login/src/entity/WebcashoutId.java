...
/**
 * WebcashoutId entity. @author MyEclipse Persistence Tools
 */

public class WebcashoutId implements java.io.Serializable {
	...
	/** full constructor */
	public WebcashoutId(String factNo, String factCode, Date yymmdd) {
		this.factNo = factNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebcashoutId))
			return false;
		WebcashoutId castOther = (WebcashoutId) other;
