...
/**
 * VKpifactEveId entity. @author MyEclipse Persistence Tools
 */

public class VKpifactEveId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VKpifactEveId))
			return false;
		VKpifactEveId castOther = (VKpifactEveId) other;
