...
/**
 * WebMats2Id entity. @author MyEclipse Persistence Tools
 */

public class WebMats2Id implements java.io.Serializable {
	...
	/** full constructor */
	public WebMats2Id(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebMats2Id))
			return false;
		WebMats2Id castOther = (WebMats2Id) other;
