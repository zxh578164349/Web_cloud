...
/**
 * WebPfavgpriceId entity. @author MyEclipse Persistence Tools
 */

public class WebPfavgpriceId implements java.io.Serializable {
	...
	/** default constructor */
	public WebPfavgpriceId() {
	}

	/** full constructor */
	public WebPfavgpriceId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebPfavgpriceId))
			return false;
		WebPfavgpriceId castOther = (WebPfavgpriceId) other;
