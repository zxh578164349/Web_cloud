...
/**
 * WebProfitId entity. @author MyEclipse Persistence Tools
 */

public class WebProfitId implements java.io.Serializable {
	...
	/** full constructor */
	public WebProfitId(String factNo, String billNo, Date yymm) {
		this.factNo = factNo;
		this.billNo = billNo;
		this.yymm = yymm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WebProfitId))
			return false;
		WebProfitId castOther = (WebProfitId) other;
