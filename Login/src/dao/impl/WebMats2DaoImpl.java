...
import entity.WebMats2Id;

public class WebMats2DaoImpl extends Basedao implements IWebMats2Dao {
	/**
	 * 瘛餃��Ｗ�瞈���
	 */
	...
	public List<WebMats2> selectMats2(String factNo, String yymm, int page,
		...
		List<WebMats2> sList = query.list();
		return sList;
	}
	...
	public WebMats2 findById(WebMats2Id id) {
		// TODO Auto-generated method stub
		String hql = "from WebMats2 w where w.id.factNo=? and w.id.billNo=? and w.id.yymm=?";
		Query query = getSession().createQuery(hql);
		query.setString(0, id.getFactNo());
		query.setString(1, id.getBillNo());
		query.setDate(2, id.getYymm());
		WebMats2 mats2 = (WebMats2) query.uniqueResult();
		return mats2;
	}
	...
	public List<WebMats2> selByYymm(String yymm, String factNo) {
		...
		if (factNo != null) {
			if (!factNo.equals("tw")) {
				String hql = "from WebMats2 where id.yymm =:yymm and id.factNo=:factNo";
				query = getSession().createQuery(hql);
				query.setParameter("yymm", s);
				query.setParameter("factNo", factNo);
			} else {
				String hql = "from WebMats2 where id.yymm =:yymm";
				query = getSession().createQuery(hql);
				query.setParameter("yymm", s);
			}
		}
		List<WebMats2> list = query.list();
		return list;
	}

	public void delete(WebMats2Id id) {
		// TODO Auto-generated method stub
		WebMats2 mat2 = this.findById(id);
		super.delete(mat2);
	...
	public PageBean findPageBean(int pageSize, int page, String factNo,
		...
		hql.append("from WebMats2 where 1=1");
		if(factNo!=null&&!factNo.equals("")&&!factNo.equals("tw")&&!factNo.equals("nothing")){
		...
		List<WebMats2>list=super.queryForPage(hql.toString(), offset, pageSize, map);
