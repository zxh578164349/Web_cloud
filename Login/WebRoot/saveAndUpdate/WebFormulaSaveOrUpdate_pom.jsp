	            ...
	            <table class="table table-condensed">	              
	               ...
	               <tr>
	                ...
	                <tr>
	                   ...
	                   <td>
	                      <input type="text" name="tabpom.hardnessUnit" value="<s:property value='tabpom.hardnessUnit'/>" datatype="*0-30" tip="Type C"/>
	                   </td>
	                   <td>
	                ...
	                <tr>
	                   ...
	                   <td>
	                     <input type="text" name="tabpom.proportionUnit" value="<s:property value='tabpom.proportionUnit'/>" datatype="*0-30" tip="g/cm3"/> 
	                   </td>
	                   <td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.forcesUnit" value="<s:property value='tabpom.forcesUnit'/>" datatype="*0-30" tip="kg/cm2"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.extendsUnit" value="<s:property value='tabpom.extendsUnit'/>" datatype="*0-30" tip="%"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.tearingCUnit" value="<s:property value='tabpom.tearingCUnit'/>" datatype="*0-30" tip="kg/cm"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.tearingKUnit" value="<s:property value='tabpom.tearingKUnit'/>" datatype="*0-30" tip="kg/cm"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.elasticityUnit" value="<s:property value='tabpom.elasticityUnit'/>" datatype="*0-30" tip="%"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.contractUnit" value="<s:property value='tabpom.contractUnit'/>" datatype="*0-30" tip="%"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.compressionUnit" value="<s:property value='tabpom.compressionUnit'/>" datatype="*0-30" tip="%"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.divisionUnit" value="<s:property value='tabpom.divisionUnit'/>" datatype="*0-30" tip="kg/cm"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.wresistingDinUnit" value="<s:property value='tabpom.wresistingDinUnit'/>" datatype="*0-30" tip="mm3"/></td>
	                ...
	                <tr>
	                   ...
	                   <td><input type="text" name="tabpom.wresistingAkronResult" value="<s:property value='tabpom.wresistingAkronResutl'/>" datatype="*0-100"/></td>
	                </tr>	                
	                <tr>
	                   <td>止滑(dry)</td>	                
	                   <td><input type="text" name="tabpom.ratioADes" value="<s:property value='tabpom.ratioADes'/>" datatype="*0-300"/></td>
	                   <td><input type="text" name="tabpom.ratioAUnit" value="<s:property value='tabpom.ratioAUnit'/>" datatype="*0-30" tip="dry"/></td>
	                ...
	                <tr>
	                   <td>止滑(wet)</td>	                
	                   <td><input type="text" name="tabpom.ratioA2Des" value="<s:property value='tabpom.ratioADes'/>" datatype="*0-300"/></td>
	                   <td><input type="text" name="tabpom.ratioA2Unit" value="<s:property value='tabpom.ratioAUnit'/>" datatype="*0-30" tip="wet"/></td>
	                   <td><input type="text" name="tabpom.ratioA2" value="<s:property value='tabpom.ratioA'/>" datatype="*8-2"/></td>
	                   <td><input type="text" name="tabpom.ratioA2Result" value="<s:property value='tabpom.ratioAResult'/>" datatype="*0-100"/></td>
	                </tr>	                
	                <tr>
	                 ...
	                 <tr>
	                   ...
	                   <td><input type="text" name="tabpom.modulus300" value="<s:property value='tabpom.modulus300Unit'/>" datatype="*0-30"/></td>
