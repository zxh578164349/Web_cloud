...
<body>
	<form action="outback_addBack" method="post" id="form">
		<table width="100%" align="center" cellspacing="0" cellpadding="0"
			...
			<tbody id="tb_list_info2">
				<s:if test="back==null">
					<tr>
						<td class="td_show_title">t<span id="sfactNo2"></span>廠別</td>
						<td class="td_input"><s:if test="#session.factNo!='tw'">
								<input type="text" style="color:blue" name="back.id.factNo"
									value="${factNo}" readonly />
							</s:if> <s:if test="#session.factNo=='tw'">
								<select style="color:blue" name="back.id.factNo"
					...
					<tr>
						...
						<td class="td_input">年 <span><select name="year"
							...
							</select> </span> <!-- <input type="text" name="back.id.yymm"   onClick="WdatePicker()" id="yymm"  onblur="clear1()" value="系統當前日期" disabled/> -->
							<span id="syymm"></span>
						</td>
						<td class="td_show_title">廠別狀態</td>
						<td class="td_input"><s:if test="#session.factNo=='tw'">
								<select name="back.factCode" id="dwrFactArea" datatype="*">
									<option value="">請選擇廠別狀態</option>
								</select>
							</s:if> <s:else>
								<select name="back.factCode" datatype="*">
									<option value="">請選擇廠別狀態</option>
				...
				<s:if test="back!=null">
					<tr>
						...
						<td class="td_input"><font color="blue"><input
								...
								value="<s:property value='back.id.factNo'/>"
								name="back.id.factNo" readonly /> </font></td>
						<td class="td_show_title">單號</td>
						<td class="td_input"><font color="blue"><input
								type="text" id="billNo" style="color:blue"
								value="<s:property value='back.id.billNo'/>"
								name="back.id.billNo" readonly /> </font></td>
					</tr>
					<tr>
						<td class="td_show_title">年月</td>
						<td class="td_input"><input type="text" style="color:blue"
							id="yymm" value="<s:date name='back.id.yymm' format='yyyyMM'/>"
							name="yymm" readonly /></td>
						<td class="td_show_title">廠別狀態</td>
						<td class="td_input">
							<%-- <input type="text" name="back.factCode" value="<s:property value='back.factCode' />"> --%>
							<select name="back.factCode" datatype="*">
								<option value="">請選擇廠別狀態</option>
								<s:iterator value="#session.factAreas_other" id="temp">
									<s:if test="#attr.temp==back.factCode">
				...
				<tr>
					...
					<td class="td_input"><input type="text" name="back.outCount"
						value="<s:property value='back.outCount'/>" datatype="*0-6">
					</td>
					<td class="td_show_title">退貨數</td>
					<td class="td_input"><input type="text" name="back.backCount"
						value="<s:property value='back.backCount'/>" datatype="*0-6">
					</td>
				</tr>
				<tr>
					<td class="td_show_title">退貨率</td>
					<td class="td_input"><input type="text" name="back.backExp"
						value="<s:property value='back.backExp'/>" datatype="*0-6">
					</td>
					<td class="td_show_title">日期起</td>
					<td class="td_input"><input type="text" name="back.dateB"
						value="<s:property value='back.dateB'/>" onClick="WdatePicker()"
						readonly class="Wdate" /></td>
				</tr>
				<tr>
					<td class="td_show_title">日期止</td>
					<td class="td_input"><input type="text" name="back.dateE"
						value="<s:property value='back.dateE'/>" onClick="WdatePicker()"
						readonly class="Wdate"></td>
					<td class="td_show_title">鎖定</td>
					<td class="td_input"><input type="text" name="back.lockMk"
						value="<s:property value='back.lockMk'/>" /></td>
				</tr>
				<tr>
					<td class="td_show_title">輸入者工號</td>
					<td class="td_input"><input type="text" name="back.userNo"
						value="${loginUser.workno}" style="color:blue" readonly></td>
					<td class="td_show_title">輸入時間</td>
					<td class="td_input"><input type="text" name="back.dateTime"
