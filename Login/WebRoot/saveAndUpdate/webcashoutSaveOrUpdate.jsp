			...
			<s:if test="cashout!=null">
				<tr>
					...
					<td class="td_input"><font color="blue"><input
							...
							name="cashout.id.factCode" readonly /> </font></td>
				</tr>
				<tr>
					<td class="td_show_title">日期</td>
		...
		<center>
			...
			<s:if test="cost!=null">
				<input type="button" value="返回" id="btn_back"
					onclick="javascript:location.href='webcashout_findPageBean'" onmouseover="this.style.backgroundPosition='left -40px'" onmouseout="this.style.backgroundPosition='left top'"/>
			</s:if>
			<s:else>
