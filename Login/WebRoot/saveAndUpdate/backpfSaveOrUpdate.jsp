	...
	<form action="backcp_addBackpf" method="post" id="form">
		<table width="100%" align="center" cellspacing="0" cellpadding="0"
			...
			<tbody id="tb_list_info">
				<s:if test="backpf==null">
					...
					<tr>
						...
						<td class="td_input">年 <span><select name="year"
							...
							</select> </span> <!-- <input type="text" name="backpf.id.yymm"   onClick="WdatePicker()" id="yymm"  onblur="clear1()" value="系統當前日期" disabled/> -->
							<span id="syymm"></span></td>
						<td class="td_show_title">廠別狀態</td>
						<td class="td_input"><s:if test="#session.factNo=='tw'">
								<select name="backpf.factCode" datatype="*" id="dwrFactArea">
									<option value="">請選擇廠別狀態</option>
								</select>
							</s:if> <s:else>
								<select name="backpf.factCode" datatype="*">
									<option value="">請選擇廠別狀態</option>
				...
				<s:if test="backpf!=null">
					<tr>
						...
						<td class="td_input"><font color="blue"><input
								...
								value="<s:property value='backpf.id.factNo'/>"
								name="backpf.id.factNo" readonly /> </font>
						</td>
						<td class="td_show_title">單號</td>
						<td class="td_input"><font color="blue"><input
								type="text" id="billNo" style="color:blue"
								value="<s:property value='backpf.id.billNo'/>"
								name="backpf.id.billNo" readonly /> </font>
						</td>
					</tr>
					<tr>
						<td class="td_show_title">年月</td>
						<td class="td_input"><input type="text" style="color:blue"
							id="yymm" value="<s:date name='backpf.id.yymm' format='yyyyMM'/>"
							name="yymm" readonly /></td>

						<td class="td_show_title">廠別狀態</td>
						<td class="td_input">
							<%-- <input type="text" name="backpf.factCode" value="<s:property value='backpf.factCode' />"> --%>
							<select name="backpf.factCode" datatype="*">
								<option value="">請選擇廠別狀態</option>
								<s:iterator value="#session.factAreas_other" id="temp">
									<s:if test="#attr.temp==backpf.factCode">
				...
				<tr>
					<td class="td_show_title">粗胚用量(Kg)</td>
					<td class="td_input"><input type="text" name="backpf.pfWeit"
						value="<s:property value='backpf.pfWeit'/>" datatype="*0-6">
					</td>
					<td class="td_show_title">回頭料（Kg）</td>
					<td class="td_input"><input type="text" name="backpf.backPf"
						value="<s:property value='backpf.backPf'/>" datatype="*0-6">
					</td>
				...
				<tr>
					...
					<td class="td_show_title">回頭率（%）</td>
					<td class="td_input"><input type="text" name="backpf.backExp"
						value="<s:property value='backpf.backExp'/>" datatype="*0-6">
					</td>


					<td class="td_show_title">油壓退料（Kg）</td>
					<td class="td_input"><input type="text"
						name="backpf.backOutput"
						value="<s:property value='backpf.backOutput'/>" datatype="*0-6">
					</td>
				...
				<tr>
					...
					<td class="td_show_title">油壓退料率（%）</td>
					<td class="td_input"><input type="text"
						name="backpf.backOutputexp"
						value="<s:property value='backpf.backOutputexp'/>" datatype="*0-6">
					</td>


					<td class="td_show_title">回頭率</td>
					<td class="td_input"><input type="text" name="backpf.backExp2"
						value="<s:property value='backpf.backExp2'/>" datatype="*0-6">
					</td>
				...
				<tr>
					...
					<td class="td_input"><input type="text" name="backpf.dateB"
						value="<s:property value='backpf.dateB' />"
						onClick="WdatePicker()" readonly class="Wdate" /></td>
					<td class="td_show_title">日期止</td>
					<td class="td_input"><input type="text" name="backpf.dateE"
						id="year" value="<s:property value='backpf.dateE'/>"
						onClick="WdatePicker()" readonly class="Wdate" /></td>

				</tr>
				<tr>
					<td class="td_show_title">鎖定</td>
					<td class="td_input"><input type="text" name="backpf.lockMk"
						id="year" value="<s:property value='backpf.lockMk'/>"
						onClick="WdatePicker()" readonly />
					</td>
					<td class="td_show_title">輸入者工號</td>
					<td class="td_input"><input type="text" name="backpf.userNo"
				...
				<tr>
					...
					<td class="td_input"><input type="text" name="backpf.dateTime"
