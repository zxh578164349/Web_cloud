...
<body>
	<form action="inv_addInv" method="post" id="form">
				...
				<s:if test="inv==null">
					<tr>
						...
						<td class="td_input"><s:if test="#session.factNo!='tw'">
								<input type="text" style="color:blue" name="inv.id.factNo"
									value="${factNo}" readonly />
							</s:if> <s:if test="#session.factNo=='tw'">
								<select style="color:blue" name="inv.id.factNo" datatype="*"
					...
					<tr>
						...
						<td class="td_input">年 <span><select name="year"
							...
							</select> </span> <!-- <input type="text" name="inv.id.yymm"   onClick="WdatePicker()" id="yymm"  onblur="clear1()" value="系統當前日期" disabled/> -->
							<span id="syymm"></span>
						</td>
						<td class="td_show_title"><span id="sfactCode2"></span>廠別狀態</td>
						<td class="td_input"><s:if test="#session.factNo=='tw'">
								<select name="inv.id.factCode" id="dwrFactArea" datatype="*">
									<option value="">請選擇廠別狀態</option>
								</select>
							</s:if> <s:else>
								<select name="inv.id.factCode" datatype="*">
									<option value="">請選擇廠別狀態</option>
									<s:iterator value="#session.factAreas_login" id="temp">
										<option value="${temp}">${temp}</option>
									</s:iterator>
								</select>
							</s:else> <span id="sfactCode"></span></td>
					</tr>
				</s:if>
				<s:if test="inv!=null">
					<tr>
						...
						<td class="td_input"><font color="blue"><input
								...
								value="<s:property value='inv.id.factNo'/>" name="inv.id.factNo"
								readonly /> </font></td>
						<td class="td_show_title">單號</td>
						<td class="td_input"><font color="blue"><input
								type="text" id="billNo" style="color:blue"
								value="<s:property value='inv.id.billNo'/>" name="inv.id.billNo"
								readonly /> </font></td>
					</tr>
					<tr>
						<td class="td_show_title">年月</td>
						<td class="td_input"><input type="text" style="color:blue"
							id="yymm" value="<s:date name='inv.id.yymm' format='yyyyMM'/>"
							name="yymm" readonly /></td>
						<td class="td_show_title">廠別狀態</td>
						<td class="td_input"><input type="text" style="color:blue"
							id="factCode" name="inv.id.factCode"
							value="<s:property value='inv.id.factCode' />" readonly /></td>
					</tr>
				</s:if>
				<tr>
					<td class="td_show_title">生產雙數</td>
					<td class="td_input"><input type="text" name="inv.output"
						value="<s:property value='inv.output'/>" datatype="*0-6">
					</td>
					<td class="td_show_title">請款雙數</td>
					<td class="td_input"><input type="text" name="inv.invCount"
						value="<s:property value='inv.invCount'/>" datatype="*0-6">
					</td>
				</tr>
				<tr>
					<td class="td_show_title">銷貨收入</td>
					<td class="td_input"><input type="text" name="inv.sellCount"
						value="<s:property value='inv.sellCount'/>" datatype="*0-6">
					</td>
					<td class="td_show_title">平均單價</td>
					<td class="td_input"><input type="text" name="inv.price"
						value="<s:property value='inv.price'/>" datatype="*0-6" /></td>
				</tr>
				<tr>
					<td class="td_show_title">日期起</td>
					<td class="td_input"><input type="text" name="inv.dateB"
						value="<s:property value='inv.dateB'/>" onClick="WdatePicker()"
						readonly class="Wdate"></td>
					<td class="td_show_title">日期止</td>
					<td class="td_input"><input type="text" name="inv.dateE"
						value="<s:property value='inv.dateE'/>" id="year"
						onClick="WdatePicker()" readonly class="Wdate" /></td>
				</tr>
				<tr>
					<td class="td_show_title">鎖定</td>
					<td class="td_input"><input type="text" name="inv.lockMk"
						value="<s:property value='inv.lockMk'/>"></td>
					<td class="td_show_title">輸入者工號</td>
					<td class="td_input"><input type="text" name="inv.userNo"
						value="${loginUser.workno}" style="color:blue" readonly></td>
				</tr>
				<tr>
					<td class="td_show_title">輸入時間</td>
					<td class="td_input"><input type="text" name="inv.dateTime"
