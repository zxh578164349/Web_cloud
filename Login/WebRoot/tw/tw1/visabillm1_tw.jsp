				...
				<td><s:property value="%{formatDate(id.kyVisabillm.dateCreate)}" />
			 	...
			 	<ul>
					...
					<%-- <a href="javascript:check('${temp.id.kyVisabillm.id.visaSort }','${temp.id.kyVisabillm.id.billNo}','${temp.id.kyVisabillm.id.factNo}')">審核</a> --%>
					 <form action="vbm_findById2_tw" method="post" id="4form${x.index}" style="float:left">
					  ...
					  <form action="vbm_findById3" method="post" id="5form${x.index}" style="float:left">
					   <input type="hidden" value="<s:property value='id.kyVisabillm.id.factNo'/>"
							name="factNo" /> <input type="hidden"
							value="<s:property value='id.kyVisabillm.id.billNo'/>" name="billNo" />						
							<input type="hidden" value="<s:property value='id.kyVisabillm.id.visaSort'/>" name="visaSort"/>
					 </form>
					 <form action="vbm_findById4_tw" method="post" id="6form${x.index}" style="float:left">
					   <input type="hidden" value="<s:property value='id.kyVisabillm.id.factNo'/>"
							name="factNo" /> <input type="hidden"
							value="<s:property value='id.kyVisabillm.id.billNo'/>" name="billNo" />						
							<input type="hidden" value="<s:property value='id.kyVisabillm.id.visaSort'/>" name="visaSort"/>
					...
					<li>					
					<a href="vbm_findById_tw?visaSort=<s:property value='id.kyVisabillm.id.visaSort'/>& billNo=<s:property value='id.kyVisabillm.id.billNo'/>& factNo=<s:property value='id.kyVisabillm.id.factNo'/>" >
					<img alt="審核" src="images/icon/check24.png" title="審核"><br>審核
					</a>
					</li>
					<s:if test='id.kyVisabillm.visaMk=="N"'>
					<li>
					 <a href="javascript:document.getElementById('4form${x.index}').submit()"><img alt="加簽" src="images/icon/add24.png" title="加簽"><br>加簽</a>
					</li>
					<li>
					 <a href="javascript:document.getElementById('6form${x.index}').submit()"><img alt="減簽" src="images/icon/minus24.png" title="減簽"><br>減簽</a>
					 ...
					 <li>
					 <a href="javascript:document.getElementById('3subform${x.index}').submit()" ><img alt="預覽" src="images/icon/view24.png" title="預覽"><br>預覽</a>
					 </li>
					 <li>
					 <a href="javascript:document.getElementById('4subform${x.index}').submit()"><img alt="打印" src="images/icon/print24.png" title="打印"><br>打印</a>
				     </li>
				</ul>
				</td> 
			</tr>		 		  
