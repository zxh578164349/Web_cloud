...
<body>
	...
	<div id="bodyid">
		<jsp:include page="table1/webdepartment1.jsp" />
	</div>
...
function findById(depid){	
	loadUrl("webdep_findById?depId="+depid);
}
function recovery(subform){
	jq.ajax({
		...
		success:function(data){
			if(data=="0"){
				//location.href="webdep_findPageBean3";
				layer.msg("回收成功",3,1);
			}else{
				layer.msg("回收失敗",3,3);
			}
