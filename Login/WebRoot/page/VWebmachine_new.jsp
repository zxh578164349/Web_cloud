  ...
  <body>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="vwebprolos_print_fact" method="post" id='subform1'
				target="_blank">
				<table class="tb_search">
					<tr>
						<td><span><input type="text" name="year" class="Wdate"
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="vwebprolos_print_month" method="post" id="subform2"
				target="_blank">
				<table class="tb_search">
					<tr>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">分形態損益表-台灣</h3>
		</div>
		<div class="panel-body">
			<form action="vwebprolos_print_tw" method="post" id="subform3"
				target="_blank">
				<table class="tb_search">
					<tr>
