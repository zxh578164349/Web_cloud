...
<title>My JSP 'gw1.jsp' starting page</title>
	...
	<table id="tb" >
		...
		<s:iterator value="bean.list" status="x" id="temp">
			<tr onmousemove="click_color(this)" onmouseout="move(this)">
				...
				<td><s:property value="lossWeit" /></td>
				<td><s:property value="lossExp" /></td>
				<td><s:property value="wlossWeit" /></td>
				<td><s:property value="wlossExp" /></td>
				<s:if test='#session.loginUser.userread!="1"'>
				<td>
					<form action="gw_findById" method="post" id="subform${x.index}">
					...
					&nbsp;
					<form action="gw_delete2" method="post" id="subform2${x.index}"
						style="float:left">
						<input type="hidden" value="<s:property value='id.factNo'/>"
							name="id.factNo" /> <input type="hidden"
							value="<s:property value='id.billNo'/>" name="id.billNo" /> <input
