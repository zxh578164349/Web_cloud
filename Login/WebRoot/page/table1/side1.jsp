...
<title>My JSP 'side1.jsp' starting page</title>
	...
	<table id="tb" >
		...
		<s:iterator value="bean.list" status="x" id="temp">
			<tr onmousemove="click_color(this)" onmouseout="move(this)">
				...
				<td><s:property value="sideWeit" />
				</td>
				<td><s:property value="sideAvg" />
				</td>
				<td><s:property value="sideExp" />
				</td>
				<td><s:property value="sideCash" />
				</td>
				<td><s:property value="badCount" />
				</td>
				<td><s:property value="badWeit" />
				</td>
				<td><s:property value="badExp" />
				</td>
				<td><s:property value="badCash" />
				</td>
				<td><s:property value="badSidew" />
				</td>
				<td><s:property value="badSidec" />
				</td>
				...
				<s:if test='#session.loginUser.userread!="1"'>
				<td>
					<form action="side_findById" method="post" id="subform${x.index}">
					...
					&nbsp;
					<form action="side_delete2" method="post" id="subform2${x.index}"
						style="float:left">
						<input type="hidden" value="<s:property value='id.factNo'/>"
							name="id.factNo" /> <input type="hidden"
							value="<s:property value='id.billNo'/>" name="id.billNo" /> <input
