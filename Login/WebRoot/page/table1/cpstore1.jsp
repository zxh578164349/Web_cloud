...
<title>My JSP 'cpstore1.jsp' starting page</title>
	...
	<table id="tb">
		...
		<s:iterator value="bean.list" status="x" id="temp">
			<tr onmousemove="click_color(this)" onmouseout="move(this)">
				...
				<td><s:property value="cpstoreB" /></td>
				<td><s:property value="noodrB" /></td>
				<td><s:property value="noinvB" /></td>
				<td><s:property value="cpT" /></td>
				<td><s:property value="cpstoreT" /></td>
				<td><s:property value="noodrT" /></td>
				<td><s:property value="noinvT" /></td>
				<td><s:property value="invT" /></td>
				<td><s:property value="invactT" /></td>
				<td><s:property value="cpinvExp" /></td>
				<td><s:property value="otherT" /></td>
				<td><s:property value="otherLoss" /></td>
				...
				<s:if test='#session.loginUser.userread!="1"'>
				<td>
					<form action="store_findById" method="post" id="subform${x.index}">
					...
					&nbsp;
					<form action="store_delete2" method="post" id="subform2${x.index}"
						style="float:left">
						<input type="hidden" value="<s:property value='id.factNo'/>"
							name="id.factNo" /> <input type="hidden"
							value="<s:property value='id.billNo'/>" name="id.billNo" /> <input
