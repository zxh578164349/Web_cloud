...
<title>My JSP 'mats21.jsp' starting page</title>
	...
	<table id="tb" >
		...
		<s:iterator value="bean.list" status="x" id="temp">
			<tr onmousemove="click_color(this)" onmouseout="move(this)">
				...
				<td><s:property value="outputCount" /></td>
				<td><s:property value="outputCash" /></td>
				<td><s:property value="cashExp" /></td>
				<td><s:property value="haoyongCount" /></td>
				<td><s:property value="countDanhao" /></td>
				...
				<s:if test='#session.loginUser.userread!="1"'>
				<td>
					<form action="mat2_findById" method="post" id="subform${x.index}">
					...
					&nbsp;
					<form action="mat2_delete2" method="post" id="subform2${x.index}"
						style="float:left">
						<input type="hidden" value="<s:property value='id.factNo'/>"
							name="id.factNo" /> <input type="hidden"
							value="<s:property value='id.billNo'/>" name="id.billNo" /> <input
