...
<title>My JSP 'machin1.jsp' starting page</title>
	...
	<table id="tb" >
		...
		<s:iterator value="bean.list" status="x" id="temp">
			<tr onmousemove="click_color(this)" onmouseout="move(this)">
				...
				<td><s:property value="machineNum" />
				</td>
				<td><s:property value="workDay" />
				</td>
				<td><s:property value="realDemo" />
				</td>
				<td><s:property value="dayDemo" />
				</td>
				<td><s:property value="weitEvg" />
				</td>
				<td><s:property value="turnNo" />
				</td>
				<td><s:property value="turnAct" />
				</td>
				...
				<s:if test='#session.loginUser.userread!="1"'>
				<td>
					<form action="machine_findById" method="post"
						id="subform${x.index}">
					...
					&nbsp;
					<form action="machine_delete2" method="post"
