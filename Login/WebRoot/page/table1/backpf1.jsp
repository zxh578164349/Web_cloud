...
<title>My JSP 'backpf1.jsp' starting page</title>
...
<body>
	<table id="tb" >
		...
		<s:iterator value="bean.list" status="x" id="temp">
			<tr onmousemove="click_color(this)" onmouseover="move(this)">
				...
				<td><s:property value="pfWeit" />
				</td>
				<td><s:property value="backPf" />
				</td>
				<td><s:property value="backExp" />
				</td>
				<td><s:property value="backOutput" />
				</td>
				<td><s:property value="backOutputexp" />
				</td>
				<td><s:property value="backExp2" />
				</td>
				...
				<s:if test='#session.loginUser.userread!="1"'>
				<td>
					<form action="backcp_findBackById" method="post"
						id="subform${x.index}">
					...
					&nbsp;
					<form action="backcp_delete2" method="post" id="subform2${x.index}"
						style="float:left">
						<input type="hidden" value="<s:property value='id.factNo'/>"
							name="id.factNo" /> <input type="hidden"
							value="<s:property value='id.billNo'/>" name="id.billNo" /> <input
