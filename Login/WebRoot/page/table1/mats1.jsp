...
<title>My JSP 'mats1.jsp' starting page</title>
	...
	<table id="tb" >
		...
		<s:iterator value="bean.list" status="x" id="temp">
			<tr onmousemove="click_color(this)" onmouseout="move(this)">
				...
				<td><s:property value="matC" />
				</td>
				<td><s:property value="matS" />
				</td>
				<td><s:property value="countDanhao" />
				</td>
				<td><s:property value="moneyDanhao" />
				</td>
				...
				<s:if test='#session.loginUser.userread!="1"'>
				<td>
					<form action="mat_findById" method="post" id="subform${x.index}">
					...
					&nbsp;
					<form action="mat_delete2" method="post" id="subform2${x.index}"
						style="float:left">
						<input type="hidden" value="<s:property value='id.factNo'/>"
							name="id.factNo" /> <input type="hidden"
							value="<s:property value='id.billNo'/>" name="id.billNo" /> <input
