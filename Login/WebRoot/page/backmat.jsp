...
<body>
	...
	<input value="添加" type="button" id="addbtn"
		onclick="javascript:location.href='saveAndUpdate/backMatSaveOrUpdate.jsp'" /></s:if>
				
	<div id="bodyid">
		<jsp:include page="table1/backmat1.jsp" />
	</div>
</body>
</html>
