...
<head>
<base href="<%=basePath%>">
<title>My JSP 'outbackShow.jsp' starting page</title>
...
<body>
	<div id="bodyid">
		<table bgColor=#97CBFF border="1"
			...
			<thead>
				<tr>
					<td class="tr_show" colspan="12"><span
						style="margin-left:370px;">出貨與退貨</span></td>
				</tr>
				<tr class="tr_show">
					<td>廠別</td>
					<td>單號</td>
			...
			<tbody id="tbody">
				<s:iterator value="#attr.outbackList">
					<tr onmousemove="click_color(this)" onmouseout="move(this)">
						...
						<td><s:property value="backCount" /></td>
						<td><s:property value="backExp" /></td>
