...
<head>
<base href="<%=basePath%>">
<title>My JSP 'machineShow.jsp' starting page</title>
...
<body>
	<div id="bodyid">
		<table bgColor=#97CBFF border=1
			...
			<thead>
				<tr>
					<td class="tr_show" colspan="16"><span
						style="margin-left:370px;">孔位數回轉數</span></td>
				</tr>
				<tr class="tr_show">
					<td>廠別</td>
					<td>單號</td>
			...
			<tbody id="tbody">
				<s:iterator value="#attr.machinList">
					<tr onmousemove="click_color(this)" onmouseout="move(this)">
						...
						<td><s:property value="machineNum" /></td>
						<td><s:property value="workDay" /></td>
						<td><s:property value="realDemo" /></td>
						<td><s:property value="dayDemo" /></td>
						<td><s:property value="weitEvg" /></td>
						<td><s:property value="turnNo" /></td>
						<td><s:property value="turnAct" /></td>
