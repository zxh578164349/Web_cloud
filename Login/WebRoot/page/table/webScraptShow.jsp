...
<body>
	<div id="bodyid">
		<table id="tb" bgColor=#97CBFF border=1
			...
			<thead>
				<tr>
					<td class="tr_show" colspan="13"><span
						style="margin-left:370px;">廢品邊料(每月輸入)</span></td>
				</tr>
				<tr class="tr_show">
					<td>序號</td>
					<td>廠別</td>
			...
			<tbody id="tbody">
			<s:iterator value="#attr.scraptList" status="x">
				<tr onmousemove="click_color(this)" onmouseout="move(this)">
					...
					<td><s:property value="%{formatDobule(otherbadweight)}" />
					</td>
