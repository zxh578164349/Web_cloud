...
<head>
<base href="<%=basePath%>">
<title>My JSP 'matstore.jsp' starting page</title>
...
<body>
	<div id="bodyid">
		<table bgColor=#97CBFF border="1"
			...
			<thead>
				<tr>
					<td class="tr_show" colspan="18"><span
						style="margin-left:370px;">全廠原料庫存</span>
					</td>
				</tr>
				<tr class="tr_show">
					<td>廠別</td>
			...
			<tbody id="tbody">
				<s:iterator value="#attr.matstoreList">
					<tr onmousemove="click_color(this)" onmouseout="move(this)">
						...
						<td><s:property value="matStore" />
						</td>
						<td><s:property value="matCash" />
						</td>
						<td><s:property value="matPrice" />
						</td>
						<td><s:property value="upMat" />
						</td>
						<td><s:property value="RWeit" />
						</td>
						<td><s:property value="RTon" />
						</td>
						<td><s:property value="RCash" />
						</td>
						<td><s:property value="RPrice" />
						</td>
						<td><s:property value="upR" />
						</td>
