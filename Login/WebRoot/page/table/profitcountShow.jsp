...
<head>
<base href="<%=basePath%>">
<title>My JSP 'profitcountShow.jsp' starting page</title>
...
<body>
	<div id="bodyid">
		<table bgColor=#97CBFF border=1
			...
			<thead>
				<tr>
					<td class="tr_show" colspan="16"><span
						style="margin-left:370px;">捐益匯總</span>
					</td>
				</tr>
				<tr class="tr_show">
					<td>廠別</td>
			...
			<tbody id="tbody">
			<s:iterator value="#attr.profitcountList">
				<tr onmousemove="click_color(this)" onmouseout="move(this)">
					...
					<td><s:property value="invCount" />
					</td>
					<td><s:property value="costCount" />
					</td>
					<td><s:property value="wageCount" />
					</td>
					<td><s:property value="cashCount" />
					</td>
					<td><s:property value="otherCount" />
					</td>
					<td><s:property value="thisProfit" />
					</td>
					<td><s:property value="realAvg" />
					</td>
					<td><s:property value="cashEvg" />
					</td>
