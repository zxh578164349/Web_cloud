...
<head>
<base href="<%=basePath%>">
<title>My JSP 'pfavgpriceShow.jsp' starting page</title>
...
<body>
	<div id="bodyid">
		<table bgColor=#97CBFF border="1"
			...
			<thead>
				<tr>
					<td class="tr_show" colspan="10"><span
						style="margin-left:370px;">平均粗胚單價</span></td>
				</tr>
				<tr class="tr_show">
					<td>廠別</td>
					<td>單號</td>
			...
			<tbody id="tbody">
				<s:iterator value="#attr.pfavgpriceList">
