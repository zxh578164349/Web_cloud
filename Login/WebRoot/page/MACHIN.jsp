...
<body>
	...
	<input value="添加" type="button" id="addbtn"
		onclick="javascript:location.href='saveAndUpdate/machineSaveOrUpdate.jsp'" /></s:if>
	<div id="bodyid">
		<jsp:include page="table1/machin1.jsp"></jsp:include>
	</div>
</body>
</html>
