...
<body>
	...
	<input value="添加" type="button" id="addbtn"
		onclick="javascript:location.href='saveAndUpdate/mastoreaveOrUpdate.jsp'" /></s:if>
	<div id="bodyid">
		<jsp:include page="table1/matsore1.jsp"></jsp:include>
	</div>
</body>
</html>
