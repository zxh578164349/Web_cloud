...
<body style="MARGIN: 0px" scroll=auto
   ...
   document.getElementById("currentTime").innerHTML = currentDate.toLocaleString(); 
	...
	<table id="tab2" border="0" height="100%" cellPadding="0"
		...
		<tr>
			...
			<td width="100%"><iframe frameBorder="0" name="show"
	   ...
	   <br>		
	   <div style="width:100%" align="center" id="tab3"><font color="grey" style="font-size:10px;">Copyright © 2014,加久企業股份有限公司,All Rights Reserved</font></div>
</body>
